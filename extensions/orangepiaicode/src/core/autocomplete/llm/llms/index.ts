import { BaseCompletionOptions, IdeSettings, ILLM, LLMOptions, ModelDescription } from "../.."
...
export async function llmFromDescription(
	...
	let options: LLMOptions = {
		...
		completionOptions: {
			...
			maxTokens: finalCompletionOptions.maxTokens ?? cls.defaultOptions?.completionOptions?.maxTokens,
		},
		systemMessage,
		writeLog,
		uniqueId,
...
export function llmFromProviderAndOptions(providerName: string, llmOptions: LLMOptions): ILLM {
