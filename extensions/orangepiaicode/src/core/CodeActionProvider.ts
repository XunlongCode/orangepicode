...
export const ACTION_NAMES = {
	EXPLAIN: "OrangePi AI Code: Explain Code",
	FIX: "OrangePi AI Code: Fix Code",
	FIX_LOGIC: "OrangePi AI Code: Fix Logic",
	IMPROVE: "OrangePi AI Code: Improve Code",
	ADD_TO_CONTEXT: "OrangePi AI Code: Add to Context",
} as const

export const COMMAND_IDS = {
	EXPLAIN: "orangepiaicode.explainCode",
	FIX: "orangepiaicode.fixCode",
	IMPROVE: "orangepiaicode.improveCode",
	ADD_TO_CONTEXT: "orangepiaicode.addToContext",
} as const
