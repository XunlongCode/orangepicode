...
export class ClineProvider extends EventEmitter<ClineProviderEvents> implements vscode.WebviewViewProvider {
	...
	*/
	...
	public static async getInstance(): Promise<ClineProvider | undefined> {
		...
		if (!visibleProvider) {
			await vscode.commands.executeCommand("orangepiaicode.SidebarProvider.focus")
				...
				switch (message.type) {
					...
					case "allowedCommands":
						...
						await vscode.workspace
							.getConfiguration("orangepiaicode")
					...
					case "humanRelayResponse":
						if (message.requestId && message.text) {
							vscode.commands.executeCommand("orangepiaicode.handleHumanRelayResponse", {
	...
	async ensureMcpServersDirectoryExists(): Promise<string> {
		...
		try {
			...
			return path.join(os.homedir(), ".orangepiaicode", "mcp")
		}
