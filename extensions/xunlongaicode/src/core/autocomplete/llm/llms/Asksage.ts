import { ChatMessage, CompletionOptions, LLMOptions, TextMessagePart } from "../../index.js"
...
class Asksage extends BaseLLM {
	...
	protected _convertArgs(options: any, messages: ChatMessage[]) {
		...
		const args: any = {
			...
			system_prompt:
				options.systemPrompt ?? "You are an expert software developer. You give helpful and concise responses.",
			tools: options.tools,
