...
export type ToCoreFromWebviewProtocol = ToCoreFromIdeOrWebviewProtocol & {
	...
	didChangeSelectedOrg: [{ id: string | null; profileId?: string | null }, void]
}
export type ToWebviewFromCoreProtocol = ToWebviewFromIdeOrCoreProtocol & {
	didChangeAvailableProfiles: [{ profiles: ProfileDescription[]; selectedProfileId: string | null }, void]
}
