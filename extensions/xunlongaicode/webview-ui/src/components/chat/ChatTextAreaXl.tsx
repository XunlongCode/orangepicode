		...
		return (
			<div
				...
				style={{
					...
					// 使用背景渐变模拟边框渐变
					// backgroundImage:
					// 	"linear-gradient(var(--vscode-input-background), var(--vscode-input-background)), linear-gradient(to right, #0078D4, #00A6D4)",
					// backgroundOrigin: "border-box",
					// backgroundClip: "padding-box, border-box",
					// boxShadow: "0 0 0 1px var(--vscode-input-background)",
				}}
				onDrop={async (e) => {
					e.preventDefault()
				...
				<div
					...
					{/* Left side - dropdowns container 改为中间的按钮 */}
					<div
						style={{
							display: "flex",
							alignItems: "center",
