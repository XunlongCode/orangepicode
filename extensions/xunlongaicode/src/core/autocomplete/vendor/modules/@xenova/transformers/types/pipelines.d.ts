...
export class ZeroShotAudioClassificationPipeline extends ZeroShotAudioClassificationPipeline_base {
	...
	): Promise<ZeroShotAudioClassificationOutput[] | ZeroShotAudioClassificationOutput[][]>
}
...
export class ZeroShotImageClassificationPipeline extends ZeroShotImageClassificationPipeline_base {
	...
	): Promise<ZeroShotImageClassificationOutput[] | ZeroShotImageClassificationOutput[][]>
}
...
export class ZeroShotObjectDetectionPipeline extends ZeroShotObjectDetectionPipeline_base {
	...
	): Promise<ZeroShotObjectDetectionOutput[] | ZeroShotObjectDetectionOutput[][]>
}
...
export type ZeroShotAudioClassificationPipelineType = TextAudioPipelineConstructorArgs &
...
export type AutomaticSpeechRecognitionPipelineType = TextAudioPipelineConstructorArgs &
...
export type ZeroShotImageClassificationPipelineType = TextImagePipelineConstructorArgs &
...
export type ZeroShotObjectDetectionPipelineType = TextImagePipelineConstructorArgs &
