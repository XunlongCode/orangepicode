...
export interface IndexingProgressUpdate {
	...
	status: "loading" | "indexing" | "done" | "failed" | "paused" | "disabled" | "cancelled"
	debugInfo?: string
}
...
export type ChatMessage = UserChatMessage | AssistantChatMessage | SystemChatMessage | ToolResultChatMessage
...
export type ToolStatus = "generating" | "generated" | "calling" | "done" | "canceled"
...
export type EditStatus = "not-started" | "streaming" | "accepting" | "accepting:full-diff" | "done"
...
export interface Config {
	...
	tabAutocompleteModel?: CustomLLM | ModelDescription | (CustomLLM | ModelDescription)[]
