...
export class Wav2Vec2ForCTC extends Wav2Vec2PreTrainedModel {
	 ...
	 */
	_call(model_inputs: { input_values: Tensor; attention_mask: Tensor }): Promise<CausalLMOutput>
}
...
export class AutoModelForSeq2SeqLM extends PretrainedMixin {
	static MODEL_CLASS_MAPPINGS: Map<
		string,
		(string | typeof T5ForConditionalGeneration)[] | (string | typeof BartForConditionalGeneration)[]
	>[]
}
/**
...
export class AutoModelForSpeechSeq2Seq extends PretrainedMixin {
	static MODEL_CLASS_MAPPINGS: Map<
		string,
		(string | typeof SpeechT5ForSpeechToText)[] | (string | typeof WhisperForConditionalGeneration)[]
	>[]
}
/**
