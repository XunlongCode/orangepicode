 ...
 */
export function setupBestConfig(config: SerializedContinueConfig): SerializedContinueConfig {
	return {
		...config,
...
export function setupLocalConfig(config: SerializedContinueConfig): SerializedContinueConfig {
	return {
		...config,
		models: [
			{
...
export function setupQuickstartConfig(config: SerializedContinueConfig): SerializedContinueConfig {
	return {
		...config,
		models: [...FREE_TRIAL_MODELS, ...config.models.filter((model) => model.provider !== "free-trial")],
		tabAutocompleteModel: {
