...
export type ToCoreFromIdeOrWebviewProtocol = {
	...
	"index/forceReIndex": [undefined | { dirs?: string[]; shouldClearIndexes?: boolean }, void]
	...
	"tools/call": [{ toolCall: ToolCall; selectedModelTitle: string }, { contextItems: ContextItem[] }]
