...
const PromptsView2 = ({ onDone, className }: PromptsViewProps) => {
	...
	return (
		<Tab className={className}>
			<TabHeader className="flex justify-between items-center px-0">
			...
			<TabContent className='px-0 pt-0'>
				...
				<div style={{ marginBottom: "20px" }}>
					<h3>{t("prompts:autocomplete.title")}</h3>
					<div style={{ marginBottom: "12px" }}>
						<div style={{ marginBottom: "8px" }}>
							<div style={{ fontWeight: "bold", marginBottom: "4px" }}>
								{t("prompts:autocomplete.apiConfiguration")}
							</div>
							<div
								style={{
									fontSize: "13px",
