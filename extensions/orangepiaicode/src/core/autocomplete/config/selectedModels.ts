...
import { GlobalContext, GlobalContextModelSelections } from "../util/GlobalContext"
...
export function rectifySelectedModelsFromGlobalContext(
	...
	const currentForProfile: GlobalContextModelSelections = currentSelectedModels?.[profileId] ?? {}
	...
	const roles: ModelRole[] = ["autocomplete", "apply", "edit", "embed", "rerank"]
