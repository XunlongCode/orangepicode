...
export function appendToHistory(prompt: string, { globalState }: ExtensionContext) {
...
export async function getHistoryQuickPickVal({ globalState }: ExtensionContext): Promise<string | undefined> {
