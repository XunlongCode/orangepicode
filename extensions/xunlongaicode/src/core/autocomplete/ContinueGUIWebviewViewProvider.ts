...
export class ContinueGUIWebviewViewProvider implements vscode.WebviewViewProvider {
	...
	getSidebarContent(
		...
		const vscMediaUrl: string = panel.webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "gui")).toString()
		...
		panel.webview.options = {
			enableScripts: true,
			localResourceRoots: [vscode.Uri.joinPath(extensionUri, "gui"), vscode.Uri.joinPath(extensionUri, "assets")],
