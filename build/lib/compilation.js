...
function compileTask(src, out, build, options = {}) {
	const task = () => {
		...
		if (build && !options.disableMangle) {
			let ts2tsMangler = new index_1.Mangler(compile.projectPath, (...data) => fancy_log_1.default(ansi_colors_1.default.blue('[mangler]'), ...data), { mangleExports: true, manglePrivateFields: true });
