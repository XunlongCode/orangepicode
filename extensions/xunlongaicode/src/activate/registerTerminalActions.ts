...
const TERMINAL_COMMAND_IDS = {
	ADD_TO_CONTEXT: "orangepiaicode.terminalAddToContext",
	FIX: "orangepiaicode.terminalFixCommand",
	FIX_IN_CURRENT_TASK: "orangepiaicode.terminalFixCommandInCurrentTask",
	EXPLAIN: "orangepiaicode.terminalExplainCommand",
	EXPLAIN_IN_CURRENT_TASK: "orangepiaicode.terminalExplainCommandInCurrentTask",
} as const
...
export const registerTerminalActions = (context: vscode.ExtensionContext) => {
	...
	registerTerminalActionPair(
		...
		"TERMINAL_FIX",
		"What would you like OrangePi AI to fix?",
	)
	...
	registerTerminalActionPair(
		...
		"TERMINAL_EXPLAIN",
		"What would you like OrangePi AI to explain?",
	)
}
