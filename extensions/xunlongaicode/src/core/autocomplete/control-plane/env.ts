...
export const EXTENSION_NAME = "orangepiaicode"
...
const WORKOS_ENV_ID_PRODUCTION = "orangepiaicode"
const WORKOS_ENV_ID_STAGING = "orangepiaicode-staging"

const PRODUCTION_ENV: ControlPlaneEnv = {
	DEFAULT_CONTROL_PLANE_PROXY_URL: "https://control-plane-api-service-i3dqylpbqa-uc.a.run.app/",
	CONTROL_PLANE_URL: "https://control-plane-api-service-i3dqylpbqa-uc.a.run.app/",
...
export async function getControlPlaneEnv(ideSettingsPromise: Promise<IdeSettings>): Promise<ControlPlaneEnv> {
	const ideSettings = await ideSettingsPromise
	return getControlPlaneEnvSync(ideSettings.continueTestEnvironment, ideSettings.enableControlServerBeta)
}
...
export async function useHub(ideSettingsPromise: Promise<IdeSettings>): Promise<boolean> {
	const ideSettings = await ideSettingsPromise
