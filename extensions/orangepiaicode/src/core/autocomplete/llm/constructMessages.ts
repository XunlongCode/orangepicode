...
function constructSystemPrompt(modelDescription: ModelDescription, useTools: boolean): string | null {
	let systemMessage =
...
export function constructMessages(
	...
	const filteredHistory = history.filter((item) => item.message.role !== "system")
